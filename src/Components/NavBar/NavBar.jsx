...
const menuItemInfo = [
    ...
    },
    {
        id: 4, category: 'صفحات', subMenu: [
            ...
            { id: 2, subMenuTitle: 'محصولات', subMenuItems: [], to: "/products" },
            { id: 3, subMenuTitle: 'تماس با ما', subMenuItems: [] },
            { id: 4, subMenuTitle: 'درباره ما', subMenuItems: [] },
            { id: 4, subMenuTitle: 'کد های تخفیف', subMenuItems: [], to: "/OfferCodes" },
        ]
    },
]
        ...
        <>
            <nav>
                <div className={`bg-main-blue w-full z-50  px-4  md:px-28  flex flex-col -top-full left-0  duration-700 ${showSmallNav && "fixed top-0 "}`}>
                    ...
                    }} className={` w-full fixed top-0 z-50 transition-all duration-400  ${activeSideBar ? 'right-0' : '-right-full '}`}>
                        <div onClick={e => e.stopPropagation()} className={`small:w-2/3  sm:w-1/2 p-4  w-[90%] h-[100vh] overflow-y-scroll  bg-main-blue border-l-[1px] border-white   `} >
                            <div className='main-navBar'>
                                <div className='close-btn'>
                                    <GrClose className='cursor-pointer text-2xl text-white' onClick={() => setActiveSideBar(false)} />
                                </div>
                                <div className='title-part flex justify-evenly items-center my-2'>
                                    <h3 className='text-xl font-semibold text-white'>لوگوی شما</h3>
                                    <h3 className='text-xl font-semibold text-white'>لوگوی شما</h3>
                                </div>
